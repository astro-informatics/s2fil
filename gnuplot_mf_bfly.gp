...
set output 'mf_bfly_spectra.eps'
...
set output 'mf_bfly_spectra.eps'
plot [2:1000] 'data_filter/mf_Tbfly_Bcmb_Stmpl_bkgnd.cl.txt' \
	with linespoints pointtype 7 pointsize 0.5 lw 2 title "Background"

set output 'mf_bfly_spectra.eps'
replot 'data_filter/mf_Tbfly_Bcmb_Stmpl_sky01.cl.txt' \
	with linespoints pointtype 7 pointsize 0.5 lw 2 title "Filter"

set output 'mf_bfly_spectra.eps'
replot 'data_filter/mf_Tbfly_Bcmb_Stmpl_tmpl_d01.cl.txt' \
